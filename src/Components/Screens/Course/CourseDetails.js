...
const CourseDetails = ({ location }) => {
    ...
    const createUploadCourseSection = () => {
        const courseSectionSid = "EDB84A54A15441808F6AED9F0F33D049E221AE34643748BEB41A0AF2FFCD64F7";
        try {
            spinner.show();
            let formData = new FormData();
            let payload = {};
            // if(document.length > 0){
            formData.append("contentLink", document);
                            ...
                            {({ handleSubmit }) => (<>
                                <form>
                                    <div >
                                        ...
                                        <TextInput type="text" name="contentName" value={contentTitle} onChange={e => setContentTitle(e.target.value)} />
                                    </div>
                                            ...
                                            <>
                                                <div className='row'>
                                                    <div className="col-md-5 mx-1 ">
                                                        ...
                                                        <input name="contentLink" type="url" placeholder='url' onChange={e => setVideoLink(e.target.value)} className="form-control" style={{ borderRadius: "30px", backgroundColor: "rgb(248, 250, 251)" }} />
...

                                    {
                                        showhide === '2' && (
                                            <div className="row form-group mx-1 mb-3">
                                                ...
                                                <input name="contentLink" type="file" className="form-control" onChange={e => setDocument(e.target.files[0])} style={{ borderRadius: "30px", backgroundColor: "rgb(248, 250, 251)" }}></input>
                                            </div>
                                        )}
